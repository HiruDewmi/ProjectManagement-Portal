                            ...
                            <div id = "frm1">
                                <form class="form-horizontal" action="process_register.php"  method="POST">
                                    <div class="form-group">
                                        <p>
                                            <img  src = "img/dialoglogoc.png"  width="65" height="auto" >  
                                        </p>
                                        <p>
                                        <h3>Registration</h3>
                                        </p>
                                        <?php
                                        session_start();
                                        if (isset($_SESSION['message-reg'])) {
                                            echo '<p style="color:red;">' . $_SESSION['message-reg'] . '</p>';
                                        }
                                        // Destroying session
                                        session_destroy();
                                        ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">          
                                            <input type="password" class="form-control" id="pas2" placeholder="confirm password" name="pas2" required>
                                        </div>
                                    </div>
                                    <div class="form-group">        
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <button type="submit" id="btn" class="btn btn-default" name="register">Register</button>
                                        </div>
                                    </div>
                                </form>
                            </div>  
